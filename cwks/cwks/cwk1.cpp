...
void setup_program_handles()
{
	...
	light_handles[0] = Var_Handle("light");
	light_handles[1] = Var_Handle("diffuse_color");
	light_handles[2] = Var_Handle("brightness");
	light_handles[3] = Var_Handle("shininess");
	light_handles[4] = Var_Handle("specular_scale");
